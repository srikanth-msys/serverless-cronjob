...
var RedisMock = function (_EventEmitter) {
  ...
  function RedisMock() {
    var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { data: {}, keyPrefix: '' };
    ...
    _this.expires = (0, _expires2.default)(options.keyPrefix);

    _this.data = (0, _data2.default)(_this.expires, options.data, options.keyPrefix);
